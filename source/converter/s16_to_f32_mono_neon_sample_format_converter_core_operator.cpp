...
void s16_to_f32_mono_neon_sample_format_converter_core_operator::perform_impl(const int16_t *CXXPH_RESTRICT src,
...
{
    assert(utils::is_aligned(src, 16));
    AARCH64_NEON_S16_TO_F32_ASM("8h", "4s"); // 16 bytes - 4 bytes
}
