...
class CascadedTrasposedDirectForm2BiquadFilterTest : public ::testing::Test {
protected:
...
void do_oneshot_overwrite_test(int n)
{
    ...
    std::cout << "elapsed: " << sw.get_elapsed_time_us() << " [us]" << std::endl;
...
#if 1
//
// general_cascaded_biquad_core_operator<general_biquad_transposed_direct_form_2_core_operator<f32_mono_frame_t>, 2>
//
class GeneralF32MonoCoreOperatorTest : public CascadedTrasposedDirectForm2BiquadFilterTest {
};

TEST_F(GeneralF32MonoCoreOperatorTest, oneshot_overwrite)
{
    typedef datatype::f32_mono_frame_t frame_t;
    typedef filter::general_biquad_transposed_direct_form_2_core_operator<frame_t> single_core_operator_t;
...
//
// general_biquad_transposed_direct_form_2_core_operator<f64_mono_frame_t>
//
class GeneralF64MonoCoreOperatorTest : public CascadedTrasposedDirectForm2BiquadFilterTest {
};
...
//
// f32_stereo_neon_biquad_transposed_direct_form_2_core_operator x2
//
class NeonF32StereoCoreOperatorTest : public CascadedTrasposedDirectForm2BiquadFilterTest {
};

TEST_F(NeonF32StereoCoreOperatorTest, oneshot_overwrite)
{
    typedef datatype::f32_stereo_frame_t frame_t;
    typedef filter::f32_stereo_neon_biquad_transposed_direct_form_2_core_operator single_core_operator_t;
    typedef filter::general_cascaded_biquad_core_operator<single_core_operator_t, 2> cascaded_core_operator_t;
    typedef filter::cascaded_biquad_filter<frame_t, cascaded_core_operator_t> filter_t;

    do_oneshot_overwrite_test<filter_t>(100000);
}
...
TEST_F(NeonF32StereoCoreOperatorTest, oneshot_non_overwrite)
{
    ...
    do_oneshot_non_overwrite_test<filter_t>(100000);
}
...
//
class NeonF32Cascaded2StereoCoreOperatorTest : public CascadedTrasposedDirectForm2BiquadFilterTest {
};

TEST_F(NeonF32Cascaded2StereoCoreOperatorTest, oneshot_overwrite)
{
    typedef datatype::f32_stereo_frame_t frame_t;
    typedef filter::f32_stereo_neon_cascaded_2_biquad_transposed_direct_form_2_core_operator cascaded_core_operator_t;
    typedef filter::cascaded_biquad_filter<frame_t, cascaded_core_operator_t> filter_t;

    do_oneshot_overwrite_test<filter_t>(100000);
}

TEST_F(NeonF32Cascaded2StereoCoreOperatorTest, oneshot_non_overwrite)
{
    typedef datatype::f32_stereo_frame_t frame_t;
    typedef filter::f32_stereo_neon_cascaded_2_biquad_transposed_direct_form_2_core_operator cascaded_core_operator_t;
    typedef filter::cascaded_biquad_filter<frame_t, cascaded_core_operator_t> filter_t;
...
TEST_F(NeonF32Cascaded2StereoCoreOperatorTest, random_size_overwrite)
{
    typedef datatype::f32_stereo_frame_t frame_t;
    typedef filter::f32_stereo_neon_cascaded_2_biquad_transposed_direct_form_2_core_operator cascaded_core_operator_t;
    typedef filter::cascaded_biquad_filter<frame_t, cascaded_core_operator_t> filter_t;
...
TEST_F(NeonF32Cascaded2StereoCoreOperatorTest, random_size_non_overwrite)
{
    typedef datatype::f32_stereo_frame_t frame_t;
    typedef filter::f32_stereo_neon_cascaded_2_biquad_transposed_direct_form_2_core_operator cascaded_core_operator_t;
    typedef filter::cascaded_biquad_filter<frame_t, cascaded_core_operator_t> filter_t;
