...
class TransposedDirectForm2BiquadFilterTest : public ::testing::Test {
protected:
...
//
// general_biquad_transposed_direct_form_2_core_operator<f32_mono_frame_t>
//
class GeneralF32MonoCoreOperatorTest : public TransposedDirectForm2BiquadFilterTest {
};

TEST_F(GeneralF32MonoCoreOperatorTest, oneshot_overwrite)
{
    typedef datatype::f32_mono_frame_t frame_t;
    typedef filter::biquad_filter<frame_t, filter::general_biquad_transposed_direct_form_2_core_operator<frame_t>>
    filter_t;
...
//
class GeneralF64MonoCoreOperatorTest : public TransposedDirectForm2BiquadFilterTest {
};
...
//
// general_biquad_transposed_direct_form_2_core_operator<f32_stereo_frame_t>
//
class GeneralF32StereoCoreOperatorTest : public TransposedDirectForm2BiquadFilterTest {
};
...
//
// general_biquad_transposed_direct_form_2_core_operator<f64_stereo_frame_t>
//
class GeneralF64StereoCoreOperatorTest : public TransposedDirectForm2BiquadFilterTest {
};
...
//
class NeonF32MonoCoreOperatorTest : public TransposedDirectForm2BiquadFilterTest {
};

TEST_F(NeonF32MonoCoreOperatorTest, oneshot_overwrite)
{
    typedef datatype::f32_mono_frame_t frame_t;
    typedef filter::biquad_filter<frame_t, filter::f32_mono_neon_biquad_transposed_direct_form_2_core_operator>
    filter_t;
...
//
class NeonF32StereoCoreOperatorTest : public TransposedDirectForm2BiquadFilterTest {
};

TEST_F(NeonF32StereoCoreOperatorTest, oneshot_overwrite)
{
    typedef datatype::f32_stereo_frame_t frame_t;
    typedef filter::biquad_filter<frame_t, filter::f32_stereo_neon_biquad_transposed_direct_form_2_core_operator>
    filter_t;
