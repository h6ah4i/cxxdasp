                  ...
                  const filter::filter_params_t &f_params2)
{
    ...
    filter::cascaded_trapezoidal_state_variable_filter<TFrame, TFilterOperator> flt;
...
int main(int argc, char const *argv[])
{
    ...
    typedef filter::general_cascaded_tsvf_core_operator<app_fallback_mono_filter_operator_t, 2>
    app_fallback_cascaded_mono_filter_operator_t;
    typedef filter::general_cascaded_tsvf_core_operator<app_fallback_stereo_filter_operator_t, 2>
    app_fallback_cascaded_stereo_filter_operator_t;

    // NOTE: No special optimized version is available for now...
    ...
    ::monstartup("cascaded-trapezoidal-state-variable-filter");
#else
    ::monstartup("cascaded-trapezoidal-state-variable-filter-no-neon");
#endif
#endif
