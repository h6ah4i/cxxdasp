...
#ifndef CXXDASP_CONVERTER_F32_TO_S16_MONO_NEON_SAMPLE_FORMAT_CONVERTER_CORE_OPERATOR_HPP_
#define CXXDASP_CONVERTER_F32_TO_S16_MONO_NEON_SAMPLE_FORMAT_CONVERTER_CORE_OPERATOR_HPP_
 ...
 */
class f32_to_s16_mono_neon_sample_format_converter_core_operator {

    /// @cond INTERNAL_FIELD
    f32_to_s16_mono_neon_sample_format_converter_core_operator(
        const f32_to_s16_mono_neon_sample_format_converter_core_operator &) = delete;
    f32_to_s16_mono_neon_sample_format_converter_core_operator &
    operator=(const f32_to_s16_mono_neon_sample_format_converter_core_operator &) = delete;
    /// @endcond
...
inline void f32_to_s16_mono_neon_sample_format_converter_core_operator::perform(
...
#endif // CXXDASP_CONVERTER_F32_TO_S16_MONO_NEON_SAMPLE_FORMAT_CONVERTER_CORE_OPERATOR_HPP_
