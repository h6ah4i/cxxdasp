...
#ifndef CXXDASP_CONVERTER_F32_TO_S16_MONO_NEON_FAST_SAMPLE_FORMAT_CONVERTER_CORE_OPERATOR_HPP_
#define CXXDASP_CONVERTER_F32_TO_S16_MONO_NEON_FAST_SAMPLE_FORMAT_CONVERTER_CORE_OPERATOR_HPP_
 ...
 * Float32 (monaural) -> Signed integer 16 (monaural)
 */
class f32_to_s16_mono_neon_fast_sample_format_converter_core_operator {

    /// @cond INTERNAL_FIELD
    f32_to_s16_mono_neon_fast_sample_format_converter_core_operator(
        const f32_to_s16_mono_neon_fast_sample_format_converter_core_operator &) = delete;
    f32_to_s16_mono_neon_fast_sample_format_converter_core_operator &
    operator=(const f32_to_s16_mono_neon_fast_sample_format_converter_core_operator &) = delete;
    /// @endcond
...
public:
     ...
     */
    typedef datatype::audio_frame<float, 1> src_frame_type;

    /**
     * Destination audio frame type.
     */
    typedef datatype::audio_frame<int16_t, 1> dest_frame_type;
...
inline void f32_to_s16_mono_neon_fast_sample_format_converter_core_operator::perform(
...
#endif // CXXDASP_CONVERTER_F32_TO_S16_MONO_NEON_FAST_SAMPLE_FORMAT_CONVERTER_CORE_OPERATOR_HPP_
