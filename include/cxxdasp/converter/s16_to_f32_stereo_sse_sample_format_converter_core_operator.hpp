...
#ifndef CXXDASP_CONVERTER_S16_TO_F32_STEREO_SSE_SAMPLE_FORMAT_CONVERTER_CORE_OPERATOR_HPP_
#define CXXDASP_CONVERTER_S16_TO_F32_STEREO_SSE_SAMPLE_FORMAT_CONVERTER_CORE_OPERATOR_HPP_
 ...
 */
class s16_to_f32_stereo_sse_sample_format_converter_core_operator {

    /// @cond INTERNAL_FIELD
    s16_to_f32_stereo_sse_sample_format_converter_core_operator(
        const s16_to_f32_stereo_sse_sample_format_converter_core_operator &) = delete;
    s16_to_f32_stereo_sse_sample_format_converter_core_operator &
    operator=(const s16_to_f32_stereo_sse_sample_format_converter_core_operator &) = delete;
    /// @endcond
...
inline void s16_to_f32_stereo_sse_sample_format_converter_core_operator::perform(
...
#endif // CXXDASP_CONVERTER_S16_TO_F32_STEREO_SSE_SAMPLE_FORMAT_CONVERTER_CORE_OPERATOR_HPP_
