...
#ifndef CXXDASP_FILTER_BIQUAD_F32_STEREO_NEON_BIQUAD_TDF2_CORE_OPERATOR_HPP_
#define CXXDASP_FILTER_BIQUAD_F32_STEREO_NEON_BIQUAD_TDF2_CORE_OPERATOR_HPP_
...
class f32_stereo_neon_biquad_transposed_direct_form_2_core_operator_impl {
public:
 ...
 */
class f32_stereo_neon_biquad_transposed_direct_form_2_core_operator {

    /// @cond INTERNAL_FIELD
    f32_stereo_neon_biquad_transposed_direct_form_2_core_operator(
        const f32_stereo_neon_biquad_transposed_direct_form_2_core_operator &) = delete;
    f32_stereo_neon_biquad_transposed_direct_form_2_core_operator &
    operator=(const f32_stereo_neon_biquad_transposed_direct_form_2_core_operator &) = delete;
    /// @endcond
...
private:
    /// @cond INTERNAL_FIELD
    typedef impl::f32_stereo_neon_biquad_transposed_direct_form_2_core_operator_impl impl_class;
...
inline f32_stereo_neon_biquad_transposed_direct_form_2_core_operator::
    f32_stereo_neon_biquad_transposed_direct_form_2_core_operator()
{
    for (auto &r : b_) {
        r = 0;
...
inline void f32_stereo_neon_biquad_transposed_direct_form_2_core_operator::set_params(double b0, double b1, double b2,
                                                                                      double a1, double a2)
    CXXPH_NOEXCEPT
{
...
inline void f32_stereo_neon_biquad_transposed_direct_form_2_core_operator::reset() CXXPH_NOEXCEPT
{
    for (auto &r : s_) {
        r = 0;
    }
...
inline void f32_stereo_neon_biquad_transposed_direct_form_2_core_operator::perform(frame_type *src_dest, int n)
    CXXPH_NOEXCEPT
{
    impl_class::perform(reinterpret_cast<float32_t *>(src_dest), n, b_, ia_, s_);
}

inline void f32_stereo_neon_biquad_transposed_direct_form_2_core_operator::perform(const frame_type *CXXPH_RESTRICT src,
...
#endif // CXXDASP_FILTER_BIQUAD_F32_STEREO_NEON_BIQUAD_TDF2_CORE_OPERATOR_HPP_
