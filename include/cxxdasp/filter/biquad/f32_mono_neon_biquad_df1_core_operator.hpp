...
#ifndef CXXDASP_FILTER_BIQUAD_F32_MONO_NEON_BIQUAD_DF1_CORE_OPERATOR_HPP_
#define CXXDASP_FILTER_BIQUAD_F32_MONO_NEON_BIQUAD_DF1_CORE_OPERATOR_HPP_
...
class f32_mono_neon_biquad_direct_form_1_core_operator_impl {
public:
...
/**
 * NEON optimized biquad filter core operator (monaural, Direct Form 1)
 */
class f32_mono_neon_biquad_direct_form_1_core_operator {

    /// @cond INTERNAL_FIELD
    f32_mono_neon_biquad_direct_form_1_core_operator(const f32_mono_neon_biquad_direct_form_1_core_operator &) = delete;
    f32_mono_neon_biquad_direct_form_1_core_operator &
    operator=(const f32_mono_neon_biquad_direct_form_1_core_operator &) = delete;
    /// @endcond
...
private:
    /// @cond INTERNAL_FIELD
    typedef impl::f32_mono_neon_biquad_direct_form_1_core_operator_impl impl_class;
...
inline f32_mono_neon_biquad_direct_form_1_core_operator::f32_mono_neon_biquad_direct_form_1_core_operator()
{
    for (auto &r : b_) {
        r = 0;
    }
...
inline void f32_mono_neon_biquad_direct_form_1_core_operator::set_params(double b0, double b1, double b2, double a1,
...
inline void f32_mono_neon_biquad_direct_form_1_core_operator::reset() CXXPH_NOEXCEPT
{
    for (auto &r : x_) {
        r = 0;
    }
...
inline void f32_mono_neon_biquad_direct_form_1_core_operator::perform(frame_type *src_dest, int n) CXXPH_NOEXCEPT
{
    impl_class::perform(reinterpret_cast<float32_t *>(src_dest), n, b_, ia_, x_, y_);
}

inline void f32_mono_neon_biquad_direct_form_1_core_operator::perform(const frame_type *CXXPH_RESTRICT src,
...
#endif // CXXDASP_FILTER_BIQUAD_F32_MONO_NEON_BIQUAD_DF1_CORE_OPERATOR_HPP_
