...
#ifndef CXXDASP_FILTER_BIQUAD_GENERAL_BIQUAD_DF1_CORE_OPERATOR_HPP_
#define CXXDASP_FILTER_BIQUAD_GENERAL_BIQUAD_DF1_CORE_OPERATOR_HPP_
...
/**
 * General biquad filter core operator (Direct Form 1)
 *
 * @tparam TFrame audio frame type
 */
template <typename TFrame>
class general_biquad_direct_form_1_core_operator {

    /// @cond INTERNAL_FIELD
    general_biquad_direct_form_1_core_operator(const general_biquad_direct_form_1_core_operator &) = delete;
    general_biquad_direct_form_1_core_operator &operator=(const general_biquad_direct_form_1_core_operator &) = delete;
    /// @endcond
...
public:
     ...
     * Constructor.
     */
    general_biquad_direct_form_1_core_operator();
...
template <typename TFrame>
inline general_biquad_direct_form_1_core_operator<TFrame>::general_biquad_direct_form_1_core_operator()
{
    for (auto &r : b_) {
        r = 0;
    }
...
template <typename TFrame>
inline void general_biquad_direct_form_1_core_operator<TFrame>::set_params(double b0, double b1, double b2, double a1,
...
template <typename TFrame>
inline void general_biquad_direct_form_1_core_operator<TFrame>::reset() CXXPH_NOEXCEPT
{
    for (auto &r : x_) {
        r = 0;
    }
...
template <typename TFrame>
inline void general_biquad_direct_form_1_core_operator<TFrame>::perform(frame_type *src_dest, int n) CXXPH_NOEXCEPT
{

#define CXXDASP_BIQUAD_DF1_STEP(offset)                                                                                \
    do {                                                                                                               \
        x2 = x1;                                                                                                       \
        x1 = x0;                                                                                                       \
        x0 = src_dest[(offset)];                                                                                       \
    ...
    for (int i = 0; i < n1; i += 4) {
        CXXDASP_BIQUAD_DF1_STEP(i + 0);
        CXXDASP_BIQUAD_DF1_STEP(i + 1);
        CXXDASP_BIQUAD_DF1_STEP(i + 2);
        CXXDASP_BIQUAD_DF1_STEP(i + 3);
    }
...
#undef CXXDASP_BIQUAD_DF1_STEP
}

template <typename TFrame>
inline void general_biquad_direct_form_1_core_operator<TFrame>::perform(const frame_type *CXXPH_RESTRICT src,
...
#endif // CXXDASP_FILTER_BIQUAD_GENERAL_BIQUAD_DF1_CORE_OPERATOR_HPP_
