...
#ifndef CXXDASP_FILTER_TSVF_F32_STEREO_NEON_TSVF_CORE_OPERATOR_HPP_
#define CXXDASP_FILTER_TSVF_F32_STEREO_NEON_TSVF_CORE_OPERATOR_HPP_
...
class f32_stereo_neon_tsvf_core_operator_impl {
public:
    static void perform(float32_t *CXXPH_RESTRICT src_dest, unsigned int n, float32x2x2_t *CXXPH_RESTRICT pic12eq,
...
/**
 * NEON optimized Linear Trapezoidal Integrated State Variable Filter core operator (stereo)
 */
class f32_stereo_neon_tsvf_core_operator {

    /// @cond INTERNAL_FIELD
    f32_stereo_neon_tsvf_core_operator(const f32_stereo_neon_tsvf_core_operator &) = delete;
    f32_stereo_neon_tsvf_core_operator &operator=(const f32_stereo_neon_tsvf_core_operator &) = delete;
    /// @endcond
...
public:
     ...
     */
    void perform(frame_type *CXXPH_RESTRICT src_dest, int n) CXXPH_NOEXCEPT;
...
private:
    /// @cond INTERNAL_FIELD
    typedef impl::f32_stereo_neon_tsvf_core_operator_impl impl_class;

    float32x4x3_t cx_;
    float32x2x2_t ic12eq_;
    /// @endcond
};

inline f32_stereo_neon_tsvf_core_operator::f32_stereo_neon_tsvf_core_operator() {}

inline f32_stereo_neon_tsvf_core_operator::~f32_stereo_neon_tsvf_core_operator() {}

inline void f32_stereo_neon_tsvf_core_operator::set_params(double a1, double a2, double a3, double m0, double m1,
...
inline void f32_stereo_neon_tsvf_core_operator::reset() CXXPH_NOEXCEPT
{
    ic12eq_.val[0] = vmov_n_f32(0.0f);
    ic12eq_.val[1] = vmov_n_f32(0.0f);
}

inline void f32_stereo_neon_tsvf_core_operator::perform(frame_type *CXXPH_RESTRICT src_dest, int n) CXXPH_NOEXCEPT
{
    impl_class::perform(reinterpret_cast<float32_t *>(src_dest), n, &ic12eq_, &cx_);
}

inline void f32_stereo_neon_tsvf_core_operator::perform(const frame_type *CXXPH_RESTRICT src,
...
#endif // CXXDASP_FILTER_TSVF_F32_STEREO_NEON_TSVF_CORE_OPERATOR_HPP_
