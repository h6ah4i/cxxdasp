...
#ifndef CXXDASP_MIXER_F32_MONO_SSE_MIXER_CORE_OPERATOR_HPP_
#define CXXDASP_MIXER_F32_MONO_SSE_MIXER_CORE_OPERATOR_HPP_
 ...
 *
 */
class f32_mono_sse_mixer_core_operator {

    /// @cond INTERNAL_FIELD
    f32_mono_sse_mixer_core_operator(const f32_mono_sse_mixer_core_operator &) = delete;
    f32_mono_sse_mixer_core_operator &operator=(const f32_mono_sse_mixer_core_operator &) = delete;
    /// @endcond
...
public:
     ...
     * Constructor.
     */
    f32_mono_sse_mixer_core_operator() {}
...
#endif // CXXDASP_MIXER_F32_MONO_SSE_MIXER_CORE_OPERATOR_HPP_
