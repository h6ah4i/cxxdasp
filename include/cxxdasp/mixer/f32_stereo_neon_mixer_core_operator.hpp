...
#ifndef CXXDASP_MIXER_F32_STEREO_NEON_MIXER_CORE_OPERATOR_HPP_
#define CXXDASP_MIXER_F32_STEREO_NEON_MIXER_CORE_OPERATOR_HPP_
 ...
 *
 */
class f32_stereo_neon_mixer_core_operator {

    /// @cond INTERNAL_FIELD
    f32_stereo_neon_mixer_core_operator(const f32_stereo_neon_mixer_core_operator &) = delete;
    f32_stereo_neon_mixer_core_operator &operator=(const f32_stereo_neon_mixer_core_operator &) = delete;
    /// @endcond
...
public:
     ...
     * Constructor.
     */
    f32_stereo_neon_mixer_core_operator() {}
...
#endif // CXXDASP_MIXER_F32_STEREO_NEON_MIXER_CORE_OPERATOR_HPP_
