...
#ifndef CXXDASP_RESAMPLER_POLYPHASE_F32_MONO_SSE_POLYPHASE_CORE_OPERATOR_HPP_
#define CXXDASP_RESAMPLER_POLYPHASE_F32_MONO_SSE_POLYPHASE_CORE_OPERATOR_HPP_
 ...
 */
class f32_mono_sse_polyphase_core_operator {

    /// @cond INTERNAL_FIELD
    f32_mono_sse_polyphase_core_operator(const f32_mono_sse_polyphase_core_operator &) = delete;
    f32_mono_sse_polyphase_core_operator &operator=(const f32_mono_sse_polyphase_core_operator &) = delete;
    /// @endcond
...
/** Number of channels */
     ...
     * Constructor.
     */
    f32_mono_sse_polyphase_core_operator() {}
...
#endif // CXXDASP_RESAMPLER_POLYPHASE_F32_MONO_SSE_POLYPHASE_CORE_OPERATOR_HPP_
