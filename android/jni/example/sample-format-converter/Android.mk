...
LOCAL_MODULE := sample-format-converter
LOCAL_SRC_FILES := sample-format-converter/sample-format-converter.cpp
...
#
# example (sample-format-converter-no-neon)
#
# if $(TARGET_ARCH_ABI) == {armeabi-v7a | armeabi-v7a-hard}
ifneq (, $(filter armeabi-v7a armeabi-v7a-hard, $(TARGET_ARCH_ABI)))
...
LOCAL_MODULE := sample-format-converter-no-neon
LOCAL_SRC_FILES := sample-format-converter/sample-format-converter.cpp
LOCAL_C_INCLUDES := $(LOCAL_PATH)/include
...
include $(CLEAR_VARS)
LOCAL_MODULE := sample-format-converter-no-neon
LOCAL_MODULE_FILENAME := sample-format-converter-no-neon-dummy
