...
#
# example (cascaded-trapezoidal-state-variable-filter)
#
LOCAL_PATH := $(CXXDASP_TOP_DIR)/example

include $(CLEAR_VARS)

LOCAL_MODULE := cascaded-trapezoidal-state-variable-filter
LOCAL_SRC_FILES := cascaded-trapezoidal-state-variable-filter/cascaded-trapezoidal-state-variable-filter.cpp
...
#
# example (cascaded-trapezoidal-state-variable-filter-no-neon)
#
# if $(TARGET_ARCH_ABI) == {armeabi-v7a | armeabi-v7a-hard}
ifneq (, $(filter armeabi-v7a armeabi-v7a-hard, $(TARGET_ARCH_ABI)))
...
LOCAL_MODULE := cascaded-trapezoidal-state-variable-filter-no-neon
LOCAL_SRC_FILES := cascaded-trapezoidal-state-variable-filter/cascaded-trapezoidal-state-variable-filter.cpp
LOCAL_C_INCLUDES := $(LOCAL_PATH)/include
...
include $(CLEAR_VARS)
LOCAL_MODULE := cascaded-trapezoidal-state-variable-filter-no-neon
LOCAL_MODULE_FILENAME := cascaded-trapezoidal-state-variable-filter-no-neon-dummy
