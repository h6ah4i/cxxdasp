...
LOCAL_MODULE := x2-resampler
LOCAL_SRC_FILES := x2-resampler/x2-resampler.cpp
...
LOCAL_MODULE := x2-resampler-no-neon
LOCAL_SRC_FILES := x2-resampler/x2-resampler.cpp
LOCAL_C_INCLUDES := $(LOCAL_PATH)/include
...
include $(CLEAR_VARS)
LOCAL_MODULE := x2-resampler-no-neon
LOCAL_MODULE_FILENAME := x2-resampler-no-neon-dummy
