...
LOCAL_MODULE := trapezoidal-state-variable-filter
LOCAL_SRC_FILES := trapezoidal-state-variable-filter/trapezoidal-state-variable-filter.cpp
...
#
# example (trapezoidal-state-variable-filter-no-neon)
#
# if $(TARGET_ARCH_ABI) == {armeabi-v7a | armeabi-v7a-hard}
ifneq (, $(filter armeabi-v7a armeabi-v7a-hard, $(TARGET_ARCH_ABI)))
...
LOCAL_MODULE := trapezoidal-state-variable-filter-no-neon
LOCAL_SRC_FILES := trapezoidal-state-variable-filter/trapezoidal-state-variable-filter.cpp
LOCAL_C_INCLUDES := $(LOCAL_PATH)/include
...
include $(CLEAR_VARS)
LOCAL_MODULE := trapezoidal-state-variable-filter-no-neon
LOCAL_MODULE_FILENAME := trapezoidal-state-variable-filter-no-neon-dummy
