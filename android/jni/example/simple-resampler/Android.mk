...
#
# example (simple-resampler)
#
LOCAL_PATH := $(CXXDASP_TOP_DIR)/example

include $(CLEAR_VARS)

LOCAL_MODULE := simple-resampler
LOCAL_SRC_FILES := simple-resampler/simple-resampler.cpp
...
#
# example (simple-resampler-no-neon)
#
# if $(TARGET_ARCH_ABI) == {armeabi-v7a | armeabi-v7a-hard}
ifneq (, $(filter armeabi-v7a armeabi-v7a-hard, $(TARGET_ARCH_ABI)))
...
LOCAL_MODULE := simple-resampler-no-neon
LOCAL_SRC_FILES := simple-resampler/simple-resampler.cpp
LOCAL_C_INCLUDES := $(LOCAL_PATH)/include
...
include $(CLEAR_VARS)
LOCAL_MODULE := simple-resampler-no-neon
LOCAL_MODULE_FILENAME := simple-resampler-no-neon-dummy
