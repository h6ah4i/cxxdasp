...
TEST_APP_BASENAME := test_utils_utils
TEST_TOP_DIR := $(CXXDASP_TOP_DIR)/test
TEST_SRC_FILES := \
    utils_utils/copy.cpp \
    utils_utils/misc.cpp \
    utils_utils/multiply_complex.cpp \
    utils_utils/multiply_real.cpp \
    utils_utils/conj.cpp \
    utils_utils/mirror_conj.cpp \
    utils_utils/interleave.cpp
